...
function r() {
    for (var c = JSON.parse(localStorage.lang), b = JSON.parse(localStorage.shortcut), d = JSON.parse(localStorage.iconClick), h = JSON.parse(localStorage.theme), k = document.getElementsByClassName("color"), a = 0; a < k.length; a++) k[a].addEventListener("click", function () {
        s()
    }, false);
    k = document.getElementsByName("theme");
    for (a = 0; a < k.length; a++) k[a].addEventListener("change", function () {
        s()
    }, false);
    document.getElementsByName("lang")[0].addEventListener("change", function () {
        s()
    }, false);
    document.getElementsByName("iconClick")[0].addEventListener("change", function () {
        s()
    }, false);
    document.getElementsByClassName("add")[0].addEventListener("click", function () {
        u("1")
    }, false);
    document.getElementsByClassName("radios")[0].addEventListener("click", function () {
        s("1")
    }, false);
    document.getElementsByClassName("radios")[1].addEventListener("click", function () {
        s("2")
    }, false);
    document.getElementsByClassName("radios")[2].addEventListener("click", function () {
        s("3")
    }, false);
    document.getElementsByClassName("preview")[0].addEventListener("click", function () {
        v("0", this)
    }, false);
    document.getElementsByClassName("preview")[1].addEventListener("click", function () {
        v("1", this)
    }, false);
    document.getElementsByClassName("buttons")[1].addEventListener("click", function () {
        a: {
            ...
            for (var j = [], g = 0, e = 0; e < document.getElementsByClassName("short").length; e++) {
                if (document.preferences.shortcut[e * 2][0].selected == true && document.preferences.shortcut[e * 2 + 1][0].selected == true) {
            ...
            g[4] = document.preferences.theme[4].value;
            for (e = 0; e < 4; e++) if (document.preferences.iconSet[e].checked == true) g[5] = "images/" + (e + 16) + ".png";
            if (i == false) {
    ...
    document.getElementById("range_dot").addEventListener("mousedown", function () {
        x()
    }, false);
    k = document.getElementsByTagName("li");
    for (a = 0; a < 3; a++) k[a].addEventListener("click", y, false);
    document.getElementById("back_image").style.background = "url(" + chrome.extension.getURL("images/128.png") + ")";
    a = chrome.extension.getURL("images/controls.png");
    document.getElementsByClassName("add")[0].style.background = "transparent url(" + a + ") no-repeat -48px 0px";
    a = chrome.extension.getURL("images/icons.png");
    ...
    if (i == false) {
        ...
        for (a = 0; a < document.preferences.lang.length; a++) document.preferences.lang[a].innerHTML = q;
        for (f = 0; f < 3; f++) for (a = 0; a < document.preferences.lang[f].length; a++) if (document.preferences.lang[f][a].value == c[f]) document.preferences.lang[f][a].selected = true;
        u(b.length / 5);
        ...
        for (a = 0; a < b.length / 5; a++) for (c = 0; c < document.preferences.lang[3 + a].length; c++) if (document.preferences.lang[3 + a][c].value == b[a + 4 * a]) document.preferences.lang[3 + a][c].selected = true;
        ...
        document.getElementsByClassName("notify_cont")[0].innerHTML += "In offline mode you just can change Theme preferences";
    ...
    for (c = 0; c < document.preferences.theme[0].length; c++) if (document.preferences.theme[0][c].value == h[2]) document.preferences.theme[0][c].selected = true;
    ...
    x(h[4]);
    for (a = 16; a < 20; a++) document.getElementById("iconSelection").innerHTML += "<input type='radio' name='iconSet'/> <img src='" + chrome.extension.getURL("images/" + a + ".png") + "'/><br>";
    for (a = 16; a < 20; a++) if (h[5] == "images/" + a + ".png") document.preferences.iconSet[a - 16].checked = true;
    if (localStorage.version == null || localStorage.version != "1.5") {
...
function u(c) {
    for (var b = 0; b < c; b++) {
        ...
        d[d.length - 2].addEventListener("change", function () {
            s()
        }, false);
        d[d.length - 1].addEventListener("change", function () {
            s()
        }, false);
        d = document.getElementsByClassName("delete");
        d[d.length - 1].addEventListener("click", function () {
    ...
    c = chrome.extension.getURL("images/controls.png");
...
function s(c) {
    ...
    for (var b = 0; b < document.getElementsByClassName("short").length; b++) {    
        document.preferences.shortcut[b * 2 + 1].disabled =
            document.preferences.shortcut[b * 2][0].selected == true ?
            true : false;
    }
    ...
    c = chrome.extension.getURL("images/controls.png");
    for (b = 1; b < 4; b++) {
        if (document.preferences.iconClick[b].checked == true && document.preferences.iconClick[0].checked == false) document.getElementsByClassName("radios")[b - 1].style.background = "url(" + c + ") no-repeat -64px 0px";
    ...
    b.lineTo(7, 8);
    b.fill();
    document.getElementById("bubble_cont").style.fontFamily = document.preferences.theme[0].value;
...
function v(c, b) {
    if (c == "hide") {
        ...
        if (c == "0") document.getElementsByClassName("colors")[1].style.display = "none";
...
window.onload = function() {
    // save the window.event to restore it inside the callback, as it gets lost
    var e = window.event;
    MicrosoftTranslate.getLanguages(function(languages){
        window.event = e;
        availableLanguages = languages;
        localStorage.availableLanguages = JSON.stringify(languages);
        r();
    });
}